            ...
            {item.isAvailable ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`ml-2 px-4 py-2 rounded-lg font-semibold transition-colors flex items-center gap-2 disabled:opacity-50 ${
                ...
                >
                  ...
                  {isDifferentRestaurant ? "Clear Cart & Add" : "Add to Cart"}
                </button>
              </div>
            ) : (
              <button
